...
export function JustDoItLiveWorkspace({ projectId }: { projectId: string }) {
  ...
  return (
    <div className="mx-auto max-w-[1440px] space-y-5 px-5 py-6 lg:px-8">
      ...
      {!view ? (
        ...
        <>
          <header className="flex items-center justify-between gap-4">
            <div>
              <h1 className="text-3xl font-semibold">Just Do It</h1>
          ...
          <details className="rounded-xl border border-border bg-card p-4">
            ...
            <Textarea
              aria-label={t('Just Do It instructions')}
              className="min-h-40"
        ...
        <>
          ...
          <header>
            <h1 className="text-2xl font-semibold">{card.source.title}</h1>
