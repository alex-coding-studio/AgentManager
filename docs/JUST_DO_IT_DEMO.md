...
| Initial planning         | Add the library's sample goal. Edit the prepared Plan and confirm it.                                              | Execution requires Plan confirmation. Adding the same sample again opens the existing goal.                                                               |
| Plan adjustment          | Edit the website goal's Plan.                                                                                      | Completed Actions stay intact and read-only; upcoming titles and requirements can change. Editing is unavailable while the goal has a running simulation. |
...
| Todo                     | Open For later, add an idea, and toggle it.                                                                        | Only this goal's Todo list changes; progress and scope do not change.                                                                                     |
...
no durable persistence, no Agent-generated Plan, no Action deletion/rollback,
